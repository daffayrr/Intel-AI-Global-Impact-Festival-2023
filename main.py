...
st.set_page_config(page_title='MRI Tumor Detection', page_icon=':detective:', layout='wide')
st.markdown("""<style>.stApp { <!--max-width: 800px;--> margin:ceenter;}</style>""", unsafe_allow_html=True)

st.markdown("""<div class="container-fluid">
            <div class="row"><div class="col-md-8">
            <h1 class="display-4">MRI Tumor Detection</h1></div></div></div>""", unsafe_allow_html=True)
...
<div class="row">
<div class="col-md-12">
<p class="lead">&copy; 2023, Sagasitas Indonesia</p></div></div></div>""", unsafe_allow_html=True)
